    ...
    <>
      <div className="flex gap-2">
        <input
          ...
          type="text"
        />
        <button onClick={addTodo} className="bg-red-500 rounded-full p-1">
          등록
        </button>
      </div>
      <div>
        <span>오늘 해야할 일</span>
        <div className="bg-amber-500 w-fit flex flex-col">
          {arr.map((v, i) => (
